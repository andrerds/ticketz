    ...
    translations: {
      ...
      mediaManagement: {
        ...
        messages: {
          ...
          bulkDeleteSuccess: "Mediendateien erfolgreich gelöscht",
          protected: "Geschützt (weniger als 30 Tage)",
          mediaDeleted: {
            text: "Medien manuell entfernt",
            tooltip: "Diese Medien wurden manuell vom Administrator entfernt",
          },
        },
        confirmDialog: {
          title: "Löschen bestätigen",
          message:
            "Sind Sie sicher, dass Sie diese Medien löschen möchten? Diese Aktion kann nicht rückgängig gemacht werden.",
        },
      },
      messagesAPI: {
        title: "API",
